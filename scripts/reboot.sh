...
screen -S 'handler-3.1' -m -d python3 handler.py --audio-raw /dev/shm/192.168.3.1.bin --janus-port 60001 --janus-ip $janus_ip --time-interval-start-stream 6 --time-interval-stop-stream 10 --check-period 1
